...
struct Game_window : Graph_lib::Window {
    ...
    Game_window(Point xy, int w, int h, const string& title, int grid_sz); // should possibly take in the players name in order to save the player score once game is finished
